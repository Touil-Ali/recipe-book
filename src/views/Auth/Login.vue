          ...
          <div class="mx-auto mb-4 max-w-[400px] pb-4">
            <form name="wf-form-password" method="get">
              <div class="relative">
                ...
                <input type="email" class="mb-4 block h-9 w-full rounded-md border border-solid border-[#FF894D]  px-3 py-6 pl-14 text-sm text-[#333333]" placeholder="Email Address" required="" />
              </div>
              <div class="relative mb-4">
                ...
                <input type="password" class="mb-4 block h-9 w-full rounded-md border border-solid border-[#FF894D] px-3 py-6 pl-14 text-sm text-[#333333]" placeholder="Password (min 8 characters)" required="" />
              </div>
              <input type="submit" value="Sign In" class="mt-4 inline-block w-full cursor-pointer items-center bg-[#FF894D] rounded-md bg-black px-6 py-3 text-center font-semibold text-white" />
            </form>
          </div>
